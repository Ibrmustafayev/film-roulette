...
export function HomeContent({ genres }: { genres: Genre[] }) {
  ...
  return (
    <div className="flex flex-col min-h-screen relative">
      ...
      <main aria-label="Main Content" className="flex-1 container mx-auto px-4 py-12 md:py-20 flex flex-col items-center">
        {activeView === "random" && (
          <>
