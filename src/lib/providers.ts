 ...
 * - Secondary Tier (Fallback, High Availability): Embed.su, LordFlix (snowhouse.lordflix.club)
 * - Tertiary Tier (Last Resort): SuperEmbed, 2Embed, SmashyStream
 */
